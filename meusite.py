...
def saveDetails():  
    ...
    if request.method == "POST":  
        try:  
            ...
            return render_template("banco_success.html", msg = msg)  
            con.close()
...
def deleterecord():  
    ...
    with sqlite3.connect("employee.db") as con:  
        try:  
            ...
            return render_template("banco_delete_record.html",msg = msg)
...
def view():  
    ...
    rows = cur.fetchall()  
    return render_template("banco_view.html",rows = rows)